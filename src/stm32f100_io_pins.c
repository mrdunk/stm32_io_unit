...
const port_data_size port_type_data_size[] = {
    DATA_SIZE_OUT,  // BINARY_OUT_PP
    DATA_SIZE_OUT,  // BINARY_OUT_OD
    DATA_SIZE_PWM,  // PWM_BITBANG
    DATA_SIZE_D_IN, // BINARY_IN_PU
    DATA_SIZE_D_IN, // BINARY_IN_PD
    DATA_SIZE_D_IN, // BINARY_IN_OD
    DATA_SIZE_1_WIRE, // SERIAL_1_WIRE
};
